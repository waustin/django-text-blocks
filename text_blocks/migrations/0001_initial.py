...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'text_blocks_textblock', (
        ...
        db.send_create_signal(u'text_blocks', ['TextBlock'])


    def backwards(self, orm):
        # Deleting model 'TextBlock'
        db.delete_table(u'text_blocks_textblock')


    models = {
        u'text_blocks.textblock': {
